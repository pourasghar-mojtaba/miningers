...
<div class="dataBox modalMain col-md-12 col-md-offset-0" style="hieght:500px">
<header class="modalHeader">
<div class="closer modalCloser icon-cancel"></div>
<?php echo __('add_image'); ?>
</header>
 
   <?php echo $this->Form->create('User', array('id'=>'ChangeImage','name'=>'ChangeImage','enctype'=>'multipart/form-data','action'=>'/edit_cover_image','class'=>'myForm')); ?>
                    ...
                    <div class="col-sm-12" style="text-align: center;">  
							...
							<div class="col-sm-12" style="text-align: center;margin: auto;">								
                                <div class="pane clearfix">
                                 <img style="cursor: pointer;" id="add_image" src="<?php echo __SITE_URL.'img/sample_cover.png' ?>" />
                            ...
                            <input type="file" id='cover_image' style="display:none" name="data[User][cover_image]">                                      
