			...
			<?php if($this->Session->check('Message.flash')) {?>
			 ...
			 <div class="row-fluid sortable ui-sortable">	
				<div class="box span12">
					...
					<?php echo $this->Form->create('Infractionreport', array('id'=>'SearchFrom','name'=>'SearchFrom')); ?>
						<div class="row-fluid">
							<div class="span6">
							...
							<div class="span6">
								...
								<input type="text" placeholder="<?php echo __('search_in_report_content'); ?>" name="data[Infractionreport][search]" aria-controls="DataTables_Table_0"></label>
								</div>
						...
						<table class="table table-bordered table-striped table-condensed">
							  <thead>
								  <tr>
									  <th><?php echo $this->Paginator->sort('Infractionreport.id', __('id'));?></th>
									  <th><?php echo $this->Paginator->sort('FUser.name',__('from_user'));?></th>
									  <th><?php echo $this->Paginator->sort('User.name',__('name'));?></th>
									  <th><?php echo $this->Paginator->sort('Infractionreport.report',__('report'));?></th>  
									  <th><?php echo $this->Paginator->sort('Infractionreport.created',__('created'));?></th> 
							  ...
							  <?php 
								...
								?>
										<tr>								
											<td class="center"><?php echo $infraction_report['Infractionreport']['id']; ?></td>
											<td class="center"><?php echo $infraction_report['FUser']['name']; ?></td>
											<td class="center"><?php echo $infraction_report['User']['name']; ?></td>
											<td class="center"><?php echo $this->Gilace->filter_editor($infraction_report['Infractionreport']['report']); ?></td>  
											<td class="center"><?php echo $infraction_report['Infractionreport']['created']; ?></td>
											<td class="center ">
												 
												  
												<a href="<?php echo __SITE_URL.'admin/infractionreports/delete/'.$infraction_report['Infractionreport']['id']; ?>" class="btn btn-danger" 
