			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i><?php echo __('edit_newsletter') ?></h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal">
							<fieldset>
							  <div class="control-group">
								...
								<div class="controls">
								  ...
								  <input class="input-xlarge focused" name="data[Newsletter][title]" id="focusedInput" type="text"  value="<?php echo $newsletter['Newsletter']['title'] ; ?>">
								</div>
								
								<div class="controls">
								  <label class="control-label" for="focusedInput"><?php echo __('preview_email') ?> :</label>
								  <input class="input-xlarge focused" name="data[Newsletter][preview_email]" id="focusedInput" type="text"  value="<?php echo $newsletter['Newsletter']['preview_email'] ; ?>">
								  <?php echo __('preview_email_detail') ?>
								</div>
							...
							if($newsletter['Newsletter']['newsletter_template_id']==$template['Newslettertemplate']['id']){
								...
								<div class="controls">
								  ...
								  <textarea class="input-xlarge focused" name="data[Newsletter][body]" id="first_editor" >
								  	<?php echo $this->Gilace->convert_character_editor($newsletter['Newsletter']['body']) ; ?>
								  </textarea>
								</div>	
