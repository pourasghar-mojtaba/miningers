...
(function($) {
    ...
    Cropit = function() {
        Cropit._DEFAULTS = {
            ...
            fitWidth: false,
            fitHeight: false,
			keys:[ "mousedown", "mouseup", "mouseleave", "touchstart", "touchend", "touchcancel", "touchleave" ]
        };
        Cropit.PREVIEW_EVENTS = function() {
            return Cropit._DEFAULTS['keys'].map(function(type) {
                return "" + type + ".cropit";
            }).join(" ");
        }();
        ...
        disable: function() {
            return this.each(function() {
               ...
               // return cropit.disable();
				return cropit != null ? cropit.disable() : void 0;
            });
        },
        reenable: function() {
            return this.each(function() {
