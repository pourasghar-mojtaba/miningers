...
(function (a) {
	...
	a.widget("ui.autocomplete", {
		...
		_renderItem: function (b, c) {
			 //alert("<a><span class='label'><label>" + c.label +' | '+ c.tag_count+"</label></span></a>");
			return a("<li></li>").data("item.autocomplete", c).append("<a><span class='label'><label>" + c.label +' | '+ c.tag_count+"</label></span></a>").appendTo(b)
		},
		_move: function (c, b) {
			if (!this.menu.element.is(":visible")) {
				this.search(null, b);
