			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i><?php echo __('add_technicalinfoitem') ?></h2>
						<div class="box-icon">
							...
							<fieldset>
							  <div class="control-group">
								...
								<div class="controls">
								  ...
								  <input class="input-xlarge focused" style="width:500px" value="" name="data[Technicalinfo][title]" id="focusedInput" type="text" width="250" >
								</div>
                                  ...
                                  <label class="control-label" for="focusedInput"><?php echo __('technicalinfoitem_title') ?> :</label>
                                    <table id="expense_table" cellspacing="0" cellpadding="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <input type="text" name="data[Technicalinfoitem][item][]" id="title_no_01" maxlength="255" required />
                                                </td>
                                                <td>
                                                    <input type="text" style='width:50px' name="data[Technicalinfoitem][arrangment][]" id="arrangment_no_01" maxlength="20" required />
                                                </td>
												<td>
													<select id="status_no_01" style="width:auto" name="data[Technicalinfoitem][status][]">
